...
COASTS: dict[str, list[list[tuple[float, float]]]] = {
    ...
    "0": [[(0.09, 0.10), (0.14, 0.05), (0.26, 0.03), (0.38, 0.06), (0.50, 0.03),
           (0.62, 0.05), (0.74, 0.02), (0.86, 0.06), (0.95, 0.09), (0.99, 0.16),
           (0.95, 0.22), (0.90, 0.20), (0.93, 0.27), (0.86, 0.33), (0.82, 0.38),
           (0.86, 0.44), (0.83, 0.50), (0.87, 0.56), (0.80, 0.60), (0.75, 0.66),
           (0.79, 0.72), (0.76, 0.78), (0.70, 0.84), (0.62, 0.87), (0.57, 0.90),
           (0.60, 0.96), (0.55, 0.99), (0.44, 0.99), (0.38, 0.94), (0.36, 0.87),
           (0.30, 0.83), (0.22, 0.81), (0.13, 0.76), (0.09, 0.70), (0.14, 0.65),
           (0.11, 0.61), (0.17, 0.55), (0.20, 0.50), (0.26, 0.46), (0.33, 0.43),
           (0.37, 0.38), (0.35, 0.34), (0.42, 0.32), (0.44, 0.29), (0.38, 0.28),
           (0.30, 0.27), (0.22, 0.25), (0.15, 0.28), (0.07, 0.25), (0.05, 0.17)]],
    # Kalimdor, with Teldrassil riding offshore rather than fused to the coast.
    "1": [[(0.44, 0.16), (0.55, 0.13), (0.68, 0.14), (0.80, 0.17), (0.90, 0.22),
           (0.95, 0.30), (1.00, 0.36), (0.96, 0.43), (0.92, 0.48), (0.94, 0.55),
           (0.88, 0.60), (0.90, 0.66), (0.84, 0.72), (0.86, 0.78), (0.90, 0.84),
           (0.87, 0.92), (0.80, 0.98), (0.68, 1.00), (0.58, 0.97), (0.50, 0.93),
           (0.42, 0.94), (0.34, 0.90), (0.28, 0.85), (0.20, 0.82), (0.10, 0.78),
           (0.04, 0.72), (0.08, 0.66), (0.14, 0.62), (0.09, 0.56), (0.16, 0.50),
           (0.22, 0.46), (0.20, 0.40), (0.26, 0.36), (0.22, 0.30), (0.28, 0.24),
           (0.32, 0.19)],
          [(0.30, 0.01), (0.40, 0.03), (0.46, 0.08), (0.42, 0.13), (0.32, 0.15),
           (0.22, 0.12), (0.18, 0.07), (0.22, 0.03)]],
    ...
    "530": [[(0.14, 0.14), (0.26, 0.06), (0.40, 0.10), (0.52, 0.03), (0.66, 0.05),
             (0.78, 0.02), (0.88, 0.10), (0.95, 0.20), (0.90, 0.30), (0.96, 0.40),
             (0.88, 0.48), (0.94, 0.58), (0.98, 0.70), (0.92, 0.82), (0.84, 0.94),
             (0.72, 0.99), (0.60, 0.94), (0.50, 0.98), (0.38, 0.93), (0.28, 0.86),
             (0.18, 0.88), (0.08, 0.80), (0.04, 0.68), (0.10, 0.58), (0.03, 0.48),
             (0.08, 0.38), (0.04, 0.28), (0.10, 0.20)]],
    "571": [[(0.10, 0.30), (0.18, 0.22), (0.30, 0.18), (0.40, 0.12), (0.52, 0.10),
             (0.62, 0.14), (0.72, 0.10), (0.82, 0.16), (0.90, 0.24), (0.96, 0.34),
             (0.92, 0.44), (0.97, 0.54), (0.94, 0.66), (0.98, 0.78), (0.90, 0.88),
             (0.80, 0.95), (0.68, 0.92), (0.56, 0.96), (0.44, 0.90), (0.34, 0.94),
             (0.24, 0.88), (0.14, 0.82), (0.06, 0.72), (0.10, 0.62), (0.03, 0.52),
             (0.08, 0.42)]],
    "quelthalas": [[(0.30, 0.04), (0.50, 0.02), (0.68, 0.06), (0.80, 0.14),
                    (0.86, 0.26), (0.82, 0.38), (0.90, 0.50), (0.86, 0.62),
                    (0.90, 0.74), (0.82, 0.86), (0.68, 0.95), (0.52, 0.98),
                    (0.36, 0.94), (0.24, 0.86), (0.16, 0.74), (0.20, 0.62),
                    (0.12, 0.50), (0.18, 0.38), (0.12, 0.26), (0.20, 0.14)]],
    # Two islands, and they must stay two: Bloodmyst is reached by boat.
    "azuremyst": [[(0.30, 0.03), (0.48, 0.05), (0.62, 0.12), (0.68, 0.24),
                   (0.62, 0.36), (0.48, 0.44), (0.32, 0.45), (0.18, 0.38),
                   (0.10, 0.26), (0.14, 0.13)],
                  [(0.42, 0.46), (0.60, 0.44), (0.78, 0.48), (0.90, 0.58),
                   (0.94, 0.72), (0.88, 0.86), (0.74, 0.96), (0.56, 0.99),
                   (0.38, 0.95), (0.24, 0.86), (0.16, 0.72), (0.20, 0.58),
                   (0.30, 0.50)]],
}
...
TERRAIN = {
    "Tirisfal": "#8f9a72", "Silverpine": "#7d8c6b", "WesternPlaguelands": "#a5a271",
    "EasternPlaguelands": "#9c9463", "Undercity": "#c0ad83", "Alterac": "#cfd6d8",
    "Hilsbrad": "#b3bf85", "Arathi": "#c0bb7e", "Hinterlands": "#86a06d",
    "Wetlands": "#8ea977", "LochModan": "#a2b07a", "DunMorogh": "#d2dade",
    "Ironforge": "#c0ad83", "SearingGorge": "#b07a4f", "Badlands": "#c39468",
    "BurningSteppes": "#a3663f", "Stormwind": "#c0ad83", "Elwynn": "#9fb573",
    "Westfall": "#d3c07f", "Duskwood": "#6f7a64", "Redridge": "#bb8a63",
    "DeadwindPass": "#8b8489", "SwampOfSorrows": "#7f8f6c", "BlastedLands": "#b0755c",
    "Stranglethorn": "#789e64",
    "Teldrassil": "#a9b98d", "Darnassis": "#c0ad83", "Darkshore": "#8ba189",
    "Moonglade": "#96b283", "Winterspring": "#d4dde2", "Felwood": "#8b9a6a",
    "Aszhara": "#b8a06a", "Ashenvale": "#7f9970", "StonetalonMountains": "#a3a677",
    "Ogrimmar": "#c0ad83", "Durotar": "#c48a5e", "Desolace": "#a9a583",
    "Mulgore": "#b5c184", "ThunderBluff": "#c0ad83", "Barrens": "#cbb277",
    "Dustwallow": "#7c8b6d", "Feralas": "#8fae72", "ThousandNeedles": "#c99a63",
    "UngoroCrater": "#7ba465", "Silithus": "#ceb98d", "Tanaris": "#ddc98d",
    "Netherstorm": "#9a8fb0", "BladesEdgeMountains": "#c08a5a",
    "Zangarmarsh": "#7fa89a", "Hellfire": "#b5714c", "Nagrand": "#96b072",
    "TerokkarForest": "#8a9376", "ShattrathCity": "#c0ad83",
    "ShadowmoonValley": "#7a6c85",
    "TheStormPeaks": "#d6dee3", "IcecrownGlacier": "#c9d6de",
    "HrothgarsLanding": "#cdd8de", "ZulDrak": "#a8b39a", "SholazarBasin": "#8fae72",
    "CrystalsongForest": "#a89ec4", "LakeWintergrasp": "#c2d2da",
    "Dragonblight": "#c3ccd0", "GrizzlyHills": "#7f9a6d", "BoreanTundra": "#a8b58e",
    "HowlingFjord": "#8fa382", "Dalaran": "#c0ad83",
    "EversongWoods": "#c9b06a", "Sunwell": "#d8c583", "Ghostlands": "#8e8a72",
    "SilvermoonCity": "#c0ad83",
    "AzuremystIsle": "#9fb98f", "BloodmystIsle": "#b57a72", "TheExodar": "#c0ad83",
}
DEFAULT_TERRAIN = "#bfae86"

CITIES = {"Undercity", "Ironforge", "Stormwind", "Darnassis", "Ogrimmar",
          "ThunderBluff", "ShattrathCity", "Dalaran", "SilvermoonCity", "TheExodar"}
...
NAMES = {
    "Hilsbrad": "Hillsbrad Foothills", "Ogrimmar": "Orgrimmar", "Aszhara": "Azshara",
    "Darnassis": "Darnassus", "Stranglethorn": "Stranglethorn Vale",
    "Elwynn": "Elwynn Forest", "Tirisfal": "Tirisfal Glades",
    "Silverpine": "Silverpine Forest", "Alterac": "Alterac Mountains",
    "Arathi": "Arathi Highlands", "Hinterlands": "The Hinterlands",
    "Redridge": "Redridge Mountains", "Barrens": "The Barrens",
    "Dustwallow": "Dustwallow Marsh", "UngoroCrater": "Un'Goro Crater",
    "Stormwind": "Stormwind City", "Hellfire": "Hellfire Peninsula",
    "IcecrownGlacier": "Icecrown", "HrothgarsLanding": "Hrothgar's Landing",
    "ZulDrak": "Zul'Drak", "LakeWintergrasp": "Wintergrasp",
...
def trace(cells: set, gw: int, gh: int) -> list[list]:
    ...
    edges: dict = {}
    for (i, j) in cells:
        for di, dj, a, c in ((0, -1, (i, j), (i + 1, j)),
                             (1, 0, (i + 1, j), (i + 1, j + 1)),
                             (0, 1, (i + 1, j + 1), (i, j + 1)),
                             (-1, 0, (i, j + 1), (i, j))):
...
def classify(cont: dict) -> tuple[list, list, list]:
    ...
    for z in cont["zones"]:
        ...
        entry = {"name": z["name"], "id": z["area_id"], "l": ul, "r": ur,
                 "t": vt, "b": vb, "a": (ur - ul) * (vb - vt),
                 "cx": (ul + ur) / 2, "cy": (vt + vb) / 2}
...
def region(box: dict, cells: set, gw: int, gh: int, sy: float) -> dict | None:
    ...
    return {
        "name": box["name"], "label": pretty(box["name"]), "id": box["id"], "d": d,
...
def build(cid: str, cont: dict) -> dict:
    ...
    for k, box in enumerate(boxes):
        ...
        if got is not None:
            zones.append(got)
    marks = [{"name": p["name"], "label": pretty(p["name"]), "id": p["id"],
              "cx": round(p["cx"] * 1000.0, 1), "cy": round(p["cy"] * sy, 1),
              "city": True}
             for p in points]
    return {"name": cont["name"], "aspect": round(aspect, 4),
            "coast": [path(chaikin(r, 3), 1000.0, sy) for r in COASTS[cid]],
            "zones": zones, "marks": marks, "dropped": dropped}
...
def main(service_dir: str) -> None:
    ...
    for cid, r in sorted(shapes.items()):
        note = ("  DROPPED (no position in the client data): "
                + ", ".join(r["dropped"])) if r["dropped"] else ""
        print("%-12s %-18s aspect %.3f  zones %2d  marks %d%s"
