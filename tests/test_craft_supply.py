...
Crystal Vial 8925/2500cp) are read from acore_world.item_template directly -
see craft_supply's own docstring for the verification.
"""
import unittest
...
class ReagentErrandTests(unittest.TestCase):
    ...
    def test_every_vial_recipe_is_a_real_crafting_recipe(self):
        ...
        for spell_id in craft_supply.VIAL:
            found = any(
                r.spell_id == spell_id
