...
class WhereTheCodeIsAllowedToSit(unittest.TestCase):
    ...
    def test_the_styles_sit_above_every_tabs_css_slice(self):
        ...
        is swept into one."""
        self.assertLess(self.page.index(CSS_BANNER), self.page.index(CHRONICLE_CSS))
...
class TheBannerIsAlwaysVisible(unittest.TestCase):
    ...
    def test_it_is_above_the_tabs_and_below_the_outage_banner(self):
        ...
        self.assertLess(
            self.page.index('<div id="stale">'), self.page.index('<div id="agenda">')
        )
        self.assertLess(
            self.page.index('<div id="agenda">'), self.page.index('<nav id="tabs">')
        )
